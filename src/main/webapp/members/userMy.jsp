...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/members/resources/css/userMy.css">
    <script src="${pageContext.request.contextPath}/members/resources/js/userMy.js" defer></script>
