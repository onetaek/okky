...
insert into `okky`.`tags`(`value`, text) values ('Java', '자바');
insert into `okky`.`tags`(`value`, text) values ('Spring', '스프링');
insert into `okky`.`tags`(`value`, text) values ('jQuery', '제이쿼리');
insert into `okky`.`tags`(`value`, text) values ('CSS', 'CSS');
insert into `okky`.`tags`(`value`, text) values ('HTML', 'HTML');
insert into `okky`.`tags`(`value`, text) values ('javaScript', '자바스크립트');
insert into `okky`.`tags`(`value`, text) values ('C++', 'C++');
insert into `okky`.`tags`(`value`, text) values ('JSP', 'JSP');
insert into `okky`.`tags`(`value`, text) values ('Python', '파이썬');
insert into `okky`.`tags`(`value`, text) values ('SpringBoot', '스프링부트');

insert into `okky`.`statuses`(`value`, text) values('OKY','정상 회원');
insert into `okky`.`statuses`(`value`, text) values('SUS','일시 정지 회원');
insert into `okky`.`statuses`(`value`, text) values('RES','탈퇴 회원');
